...
open class FileAttachment(
    ...
    companion object {
        ...
        /**
         * The upload is currently pending, meaning it's waiting for upload, currently being
         * uploaded, or the upload failed but the user hasn't chosen to retry or cancel.
         */
