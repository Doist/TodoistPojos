...
object Sanitizers {
    ...
    @JvmField
    val PROJECT_NAME_INVALID_PATTERN: Pattern = Pattern.compile("[$PROJECT_NAME_INVALID_CHARACTERS]+")

    @JvmField
    val SECTION_NAME_INVALID_PATTERN: Pattern = Pattern.compile("[$SECTION_NAME_INVALID_CHARACTERS]+")
